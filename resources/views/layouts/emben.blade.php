<script src="{{ asset('dash/bower_components/jquery/dist/jquery.min.js') }}"></script>
  ...
  <!-- fullCalendar -->
<script src="{{ asset('dash/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('dash/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
  <!-- CK Editor -->
  <script src="{{ asset('dash/bower_components/ckeditor/ckeditor.js') }}"></script>
  <script>
    $(function () {
