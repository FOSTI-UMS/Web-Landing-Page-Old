 <head>
    ...
    <!-- fullCalendar -->
 <link rel="stylesheet" href="{{ asset('dash/bower_components/fullcalendar/dist/fullcalendar.min.css') }}">
 <link rel="stylesheet" href="{{ asset('dash/bower_components/fullcalendar/dist/fullcalendar.print.min.css') }}" media="print">
    <!-- Theme style -->
